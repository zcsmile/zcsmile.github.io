 ...
 */
        ...
        function n() {
            function e(e, n, r) {
                r = r || {};
                var o;
                return o = "string" == typeof t[e] ? t[e] : 1 === n ? t[e].one : t[e].other.replace("", n), r.addSuffix ? r.comparison > 0 ? "in " + o : o + " ago" : o
            }

            var t = {
                lessThanXSeconds: {one: "less than a second", other: "less than  seconds"},
                xSeconds: {one: "1 second", other: " seconds"},
                halfAMinute: "half a minute",
                lessThanXMinutes: {one: "less than a minute", other: "less than  minutes"},
                xMinutes: {one: "1 minute", other: " minutes"},
                aboutXHours: {one: "about 1 hour", other: "about  hours"},
                xHours: {one: "1 hour", other: " hours"},
                xDays: {one: "1 day", other: " days"},
                aboutXMonths: {one: "about 1 month", other: "about  months"},
                xMonths: {one: "1 month", other: " months"},
                aboutXYears: {one: "about 1 year", other: "about  years"},
                xYears: {one: "1 year", other: " years"},
                overXYears: {one: "over 1 year", other: "over  years"},
                almostXYears: {one: "almost 1 year", other: "almost  years"}
            };
            return {localize: e}
        }
        ...
        function n() {
            function e(e, n, r) {
                r = r || {};
                var o;
                return o = "string" == typeof t[e] ? t[e] : 1 === n ? t[e].one : t[e].other.replace("", n), r.addSuffix ? r.comparison > 0 ? o + "内" : o + "前" : o
            }

            var t = {
                lessThanXSeconds: {one: "不到 1 秒", other: "不到  秒"},
                xSeconds: {one: "1 秒", other: " 秒"},
                halfAMinute: "半分钟",
                lessThanXMinutes: {one: "不到 1 分钟", other: "不到  分钟"},
                xMinutes: {one: "1 分钟", other: " 分钟"},
                xHours: {one: "1 小时", other: " 小时"},
                aboutXHours: {one: "大约 1 小时", other: "大约  小时"},
                xDays: {one: "1 天", other: " 天"},
                aboutXMonths: {one: "大约 1 个月", other: "大约  个月"},
                xMonths: {one: "1 个月", other: " 个月"},
                aboutXYears: {one: "大约 1 年", other: "大约  年"},
                xYears: {one: "1 年", other: " 年"},
                overXYears: {one: "超过 1 年", other: "超过  年"},
                almostXYears: {one: "将近 1 年", other: "将近  年"}
            };
            return {localize: e}
        }
        ...
        function n() {
            function e(e, n, r) {
                r = r || {};
                var o;
                return o = "string" == typeof t[e] ? t[e] : 1 === n ? t[e].one : t[e].other.replace("", n), r.addSuffix ? r.comparison > 0 ? o + "內" : o + "前" : o
            }

            var t = {
                lessThanXSeconds: {one: "少於 1 秒", other: "少於  秒"},
                xSeconds: {one: "1 秒", other: " 秒"},
                halfAMinute: "半分鐘",
                lessThanXMinutes: {one: "少於 1 分鐘", other: "少於  分鐘"},
                xMinutes: {one: "1 分鐘", other: " 分鐘"},
                xHours: {one: "1 小時", other: " 小時"},
                aboutXHours: {one: "大約 1 小時", other: "大約  小時"},
                xDays: {one: "1 天", other: " 天"},
                aboutXMonths: {one: "大約 1 個月", other: "大約  個月"},
                xMonths: {one: "1 個月", other: " 個月"},
                aboutXYears: {one: "大約 1 年", other: "大約  年"},
                xYears: {one: "1 年", other: " 年"},
                overXYears: {one: "超過 1 年", other: "超過  年"},
                almostXYears: {one: "將近 1 年", other: "將近  年"}
            };
            return {localize: e}
        }
        ...
        function n() {
            function e(e, n, r) {
                r = r || {};
                var o;
                return o = "string" == typeof t[e] ? t[e] : 1 === n ? t[e].one : t[e].other.replace("", n), r.addSuffix ? r.comparison > 0 ? "en " + o : "hace " + o : o
            }

            var t = {
                lessThanXSeconds: {one: "menos de un segundo", other: "menos de  segundos"},
                xSeconds: {one: "1 segundo", other: " segundos"},
                halfAMinute: "medio minuto",
                lessThanXMinutes: {one: "menos de un minuto", other: "menos de  minutos"},
                xMinutes: {one: "1 minuto", other: " minutos"},
                aboutXHours: {one: "alrededor de 1 hora", other: "alrededor de  horas"},
                xHours: {one: "1 hora", other: " horas"},
                xDays: {one: "1 día", other: " días"},
                aboutXMonths: {one: "alrededor de 1 mes", other: "alrededor de  meses"},
                xMonths: {one: "1 mes", other: " meses"},
                aboutXYears: {one: "alrededor de 1 año", other: "alrededor de  años"},
                xYears: {one: "1 año", other: " años"},
                overXYears: {one: "más de 1 año", other: "más de  años"},
                almostXYears: {one: "casi 1 año", other: "casi  años"}
            };
            return {localize: e}
        }
        ...
        function n() {
            function e(e, n, r) {
                r = r || {};
                var o;
                return o = "string" == typeof t[e] ? t[e] : 1 === n ? t[e].one : t[e].other.replace("", n), r.addSuffix ? r.comparison > 0 ? "dans " + o : "il y a " + o : o
            }

            var t = {
                lessThanXSeconds: {one: "moins d’une seconde", other: "moins de  secondes"},
                xSeconds: {one: "1 seconde", other: " secondes"},
                halfAMinute: "30 secondes",
                lessThanXMinutes: {one: "moins d’une minute", other: "moins de  minutes"},
                xMinutes: {one: "1 minute", other: " minutes"},
                aboutXHours: {one: "environ 1 heure", other: "environ  heures"},
                xHours: {one: "1 heure", other: " heures"},
                xDays: {one: "1 jour", other: " jours"},
                aboutXMonths: {one: "environ 1 mois", other: "environ  mois"},
                xMonths: {one: "1 mois", other: " mois"},
                aboutXYears: {one: "environ 1 an", other: "environ  ans"},
                xYears: {one: "1 an", other: " ans"},
                overXYears: {one: "plus d’un an", other: "plus de  ans"},
                almostXYears: {one: "presqu’un an", other: "presque  ans"}
            };
            return {localize: e}
        }
        ...
        function n(e, t) {
            ...
            var n = t % 10, r = t % 100;
            return 1 === n && 11 !== r ? e.singularNominative.replace("", t) : n >= 2 && n <= 4 && (r < 10 || r > 20) ? e.singularGenitive.replace("", t) : e.pluralGenitive.replace("", t)
        }
